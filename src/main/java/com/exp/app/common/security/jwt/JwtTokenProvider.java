package com.exp.app.common.security.jwt;
...
public class JwtTokenProvider {
    ...
    public Authentication getAuthentication(String token) {
    	...
    	User user = appService.selectOneById(this.getUserPk(token));
    	
        UserDetails userDetails = new org.springframework.security.core.userdetails.User(user.getId(), user.getPassword(), null);
